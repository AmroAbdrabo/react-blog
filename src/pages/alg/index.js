...
function Page(props){
    ...
    tweakAnimation["--to-width"] = "20vw";
    tweakAnimation["--steps"] = "9";
    tweakAnimation["letter-spacing"]="0.04em";

    const newHeading = headerData.heading;
    newHeading["backgroundImage"] = "linear-gradient(to bottom, rgba(255, 255, 255, 0), rgba(255, 255, 255, 1)), url('/img/house.png')";
    return <body>
        <div style={headerData.heading}>
            <div>
                <h1 style = {tweakAnimation}>cd ~/algo</h1>
            </div>
        </div>
        <Cards/>
