...
function ExPage(props){
    ...
    tweakAnimation["--to-width"] = "16vw";
    tweakAnimation["--steps"] = "8";
    tweakAnimation["letter-spacing"]="0.04em";
    tweakAnimation["color"]="black";

    const newHeading = headerData.heading;
    newHeading["backgroundImage"] = "linear-gradient(to bottom, rgba(255, 255, 255, 0), rgba(255, 255, 255, 1)), url('/img/leaves.jpg')";
    return <body>
        <div style={headerData.heading}>
            <div>
                <h1 style = {tweakAnimation}>cd ~/life</h1>
            </div>
        </div>
        <Cards/>
